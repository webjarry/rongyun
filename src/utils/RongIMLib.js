...
// {WebStart} WebSDK 鍐呭寮€濮嬬殑鏍囪瘑, 鏂逛究灏忕▼搴� SDK 瀹氫綅
    var Polling = {
    ...
    (function (RongIMLib) {
        var RongIMClient = (function () {
            ...
            RongIMClient.init = function (appKey, dataAccessProvider, options, callback) {
                ...
                var isLocationInvalid = typeof location !== 'object'; // 鏈壘鍒板叏灞€ location 鍙橀噺, 鍒欏崗璁负 https. 姣斿灏忕▼搴�
                ...
                var _defaultOpts = {
                    ...
                    cmpUrl: '' // 鑻ヤ紶鍏� cmpUrl, 鍒欎紭鍏堥摼鎺ユ鍦板潃
                };
                ...
                me.socket.on("StatusChanged", function (code) {
                    ...
                    if (isNetworkUnavailable) {
                        ...
                        if (currentServer) {
                            ...
                            // 濡傛灉 currentServer 鏄� servers 鐨勬渶鍚庝竴涓紝涓嶅啀鏇挎崲浣嶇疆
            ...
            Client.prototype.invoke = function (isPullMsg, chrmId, offlineMsg) {
                ...
                this.queryMessage(str, RongIMLib.MessageUtil.ArrayForm(modules.toArrayBuffer()), target, Qos.AT_LEAST_ONCE, {
                    onSuccess: function (collection) {
                        ...
                        // 鍏煎闀胯疆璁� finished 涓虹┖鐨勯€犳垚涓㈡秷鎭儏鍐�
            ...
            MessageHandler.prototype.onReceived = function (msg, pubAckItem, offlineMsg, leftCount, isSync) {
                ...
                if (isPersited) {
                    ...
                    if (isReceiver && message.senderUserId != Bridge._client.userId) {
                        ...
                        if (RongIMLib.RongUtil.supportLocalStorage()) {
                            // var originUnreadCount = RongIMClient._storageProvider.getItem("cu" + Bridge._client.userId + con.conversationType + con.targetId); // 涓庢湰鍦板瓨鍌ㄤ細璇濆悎骞�
                ...
                if (status == 0) {
                    ...
                    if (this._client.reconnectObj.onSuccess) {
                        ...
                        isNotifyConversationList && RongIMLib.RongIMClient._dataAccessProvider.getRemoteConversationList({
                            ...
                            onError: function (code) {
                                console.log('鍐呴儴鑾峰彇鍒楄〃澶辫触: %d', code);
                            }
...
/// <reference path="../../dts/helper.d.ts"/>
    ...
    (function (RongIMLib) {
        var SocketTransportation = (function () {
            ...
            // 鏈€鐭摼鎺ユ椂闀�(鑻� 5000ms 鍐�, ws 鑷姩鏂紑, 姝� ws 鍦板潃缃负涓嶅彲鐢�)
    ...
    (function (RongIMLib) {
        ...
        var MessageUtil = (function () {
            ...
            MessageUtil.messageParser = function (entity, onReceived, offlineMsg) {
                ...
                // 瑙ｅ喅澶氱鍦ㄧ嚎鏀惰嚜宸卞彂鐨勬秷鎭椂, messageDirection 涓� 2(鎺ユ敹), 瀵艰嚧鏈鏁板鍔�
                ...
                // 鑷繁缁欒嚜宸卞彂鐨勬秷鎭�, messageDirection 涓� 2(鎺ユ敹)
        ...
        var ChrmKVHandler = (function () {
            ...
            ChrmKVHandler.setEntries = function (chrmId, entity) {
                ...
                kvCache.setTime(syncTime); // 鏇存柊鎷夊彇鏃堕棿
                event(chrmId, entries); // 鏇存柊 kv 鍊�
            };
            ...
            ChrmKVHandler.setIncreEntries = function (chrmId, entries) {
                ...
                var optEvent = function (entity, isOverwrite, eventName) {
                    ...
                    /*
                    1. 闇€瑕嗙洊鏃�, 涓嶇 key 鏄惁宸插瓨鍦�, 閮界洿鎺ヨ缃�
                    2. 涓嶈鐩栨椂, 蹇呴』鏈€鍚庝竴娆� key 涓鸿嚜宸辫缃殑鎴栨 key 杩樻湭璁剧疆杩�, 鎵嶈兘缁х画
                 */
    ...
    (function (RongIMLib) {
            ...
            */
            ...
            ServerDataProvider.prototype.setOfflineMessageDuration = function (duration, callback) {
                this.getPullSetting({
                    onSuccess: function (result) {
                        /**
                         * GetQNupTokenOutput 绗竴浣嶄负 int64, 绗簩浣嶄负 string, 涓庤缃绾挎秷鎭竴鑷�
                         * 涓洪伩鍏嶄慨鏀� Protobuf 甯︽潵鐨勬洿鏂版垚鏈�. 浠呭鐢�, 涓嶉噸鏂板懡鍚�
                         */
        ...
        */
            ...
            ServerDataProvider.prototype.setRTCState = function (room, content, callback) {
                // MCFollowInput 涓� PB 澶嶇敤锛屽瓧娈碉細涓€涓繀浼� string锛堢涓€浣嶏級
...
// {WebEnd} WebSDK 鍐呭寮€濮嬬殑鏍囪瘑, 鏂逛究灏忕▼搴� SDK 瀹氫綅
    /*
    璇存槑: 璇峰嬁淇敼 header.js 鍜� footer.js
    鐢ㄩ€�: 鑷姩鎷兼帴鏆撮湶鏂瑰紡
    鍛戒护: grunt release 涓� concat
